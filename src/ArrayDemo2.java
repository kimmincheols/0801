...
//		System.out.println("첫번째 숫자 : "); sc.nextInt();
//		/		for(int i = 0; i <4; i++) {
//			System.out.print(i + "번째 방의 값 : ");
//					array[i] = sc.nextInt();
//		}
//		System.out.println(array);   << 주소값의 출력임
//		for(int i = 0; i < 4; i++) {
...
//			for(int i = 0; i<2; i++) {
//				System.out.print(i + "번째 학생의 이름 : ");			array[i].name = sc1.nextLine();
//				System.out.print(i + "번째 학생의 나이 : ");			array[i].age = sc1.nextInt();
//				sc1.nextLine();
//			}
//			for(int j = 0; j < 2; j++) {
